...
export default class DrawerForm extends React.Component {
  ...
  handleSubmit=()=>{
    const textTitle = this.refs.titleStands.state.value;
    const textDescription = this.refs.descriptionStands.state.value;
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item label="Titre">
                  <Input ref="titleStands" placeholder={d.description||"Stand title"} />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item label="Description">
                  <Input
                      ref="descriptionStands"
                      style={{ width: '100%' }}
